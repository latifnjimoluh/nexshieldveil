...
VIEWS: tuple[str, ...] = (
    ...
    "CameraBadge.qml",
    "Veil.qml",
    # Brand-themed Qt Quick controls (leaf components used by the views below).
    "ThemedSlider.qml",
    "ThemedCheckBox.qml",
    "ThemedRadioButton.qml",
    "ThemedSwitch.qml",
    "ThemedSpinBox.qml",
    "ThemedComboBox.qml",
    "ThemedProgressBar.qml",
    "StatusView.qml",
    "AboutView.qml",
    "OnboardingView.qml",
    "SettingsView.qml",
...
def install_context(context: QQmlContext, **objects: QObject | None) -> None:
    ...
    ``onboarding``, ``about``, ``tray``, ``camera``, ``updates``, ``donate``,
    ``brand``. ``None`` values are skipped.
    """
    mapping = {
        "theme": "Theme",
        "translator": "Tr",
